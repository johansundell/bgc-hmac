...
func TestFall_1A(t *testing.T) {
	...
	dat, _ := ioutil.ReadFile("files/testfall-1a.txt")
...
func TestFall_1B(t *testing.T) {
	dat, _ := ioutil.ReadFile("files/testfall-1b.txt")
...
func TestFall_1C(t *testing.T) {
	dat, _ := ioutil.ReadFile("files/testfall-1c.txt")
...
func TestFall_2A(t *testing.T) {
	dat, _ := ioutil.ReadFile("files/hmac_testfall-2a.txt")
...
func TestFall_2B(t *testing.T) {
	dat, _ := ioutil.ReadFile("files/hmac_testfall-2b.txt")
...
func TestFall_2C(t *testing.T) {
	dat, _ := ioutil.ReadFile("files/hmac_testfall-2c.txt")
...
func TestFall_2D(t *testing.T) {
	dat, _ := ioutil.ReadFile("files/hmac_testfall-2d.txt")
